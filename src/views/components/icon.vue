    ...
    <i-article>
        <article>
            ...
            <div class="api">
                ...
                <Anchor title="Icon properties" h3></Anchor>
                <table>
                    <thead>
                    <tr>
                        <th>属性</th>
            ...
            <div class="icons">
                <div class="icons-item" v-for="item in filterIcons" @click="clip(item)">
                    <i class="i-icon" :class="[`i-icon-${item}`]" style="font-size:32px"></i>
                    <p>
                        {{ item }}
                    </p>
                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            filterIcons () {
                return this.icons.filter(icon => icon.indexOf(this.search) > -1);
            }
        },
        methods: {
            clip (type) {
                const icon = `<i-icon type="${type}" />`;
